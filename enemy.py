...
class Robber_boss(robber):
    def __init__(self, game, pos):
        ...
        self.cooldown_check = False
        # hp
        self.maximum_hp = robber_boss_hp
        self.current_hp = robber_boss_hp
        self.health_bar_length = 32

        self.speed = robber_boss_speed

        self.attack = pygame.sprite.LayeredUpdates()
        self.can_attack = False
        self.damage = robber_boss_damage
        self.attack_time = 0
        ...
        self.image = self.game.enemy_boss_spritesheet.get_sprite((0, 0), self.width, self.height, )
        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y
    ...
    def robber_animation(self):
        down_animations = [self.game.enemy_boss_spritesheet.get_sprite((3, 2), self.width, self.height),
                           self.game.enemy_boss_spritesheet.get_sprite((35, 2), self.width, self.height),
                           self.game.enemy_boss_spritesheet.get_sprite((68, 2), self.width, self.height)]

        up_animations = [self.game.enemy_boss_spritesheet.get_sprite((3, 34), self.width, self.height),
                         self.game.enemy_boss_spritesheet.get_sprite((35, 34), self.width, self.height),
                         self.game.enemy_boss_spritesheet.get_sprite((68, 34), self.width, self.height)]

        left_animations = [self.game.enemy_boss_spritesheet.get_sprite((3, 98), self.width, self.height),
                           self.game.enemy_boss_spritesheet.get_sprite((35, 98), self.width, self.height),
                           self.game.enemy_boss_spritesheet.get_sprite((68, 98), self.width, self.height)]

        right_animations = [self.game.enemy_boss_spritesheet.get_sprite((3, 66), self.width, self.height),
                            self.game.enemy_boss_spritesheet.get_sprite((35, 66), self.width, self.height),
                            self.game.enemy_boss_spritesheet.get_sprite((68, 66), self.width, self.height)]

        if self.view[0] == 0 and self.view[1] == 0:
            self.image = self.game.enemy_boss_spritesheet.get_sprite((3, 2), self.width, self.height)
